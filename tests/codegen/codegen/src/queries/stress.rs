...
pub struct EverythingArrayParams<
    ...
    T24: crate::ArraySql<Item = chrono::NaiveDateTime>,
    T25: crate::ArraySql<Item = chrono::NaiveDateTime>,
    T26: crate::ArraySql<Item = chrono::DateTime<chrono::FixedOffset>>,
    T27: crate::ArraySql<Item = chrono::DateTime<chrono::FixedOffset>>,
    T28: crate::ArraySql<Item = chrono::NaiveDate>,
    T29: crate::ArraySql<Item = chrono::NaiveTime>,
    T30: crate::JsonSql,
